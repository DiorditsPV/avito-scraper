...
SCRAPING_URLS = {
    ...
    "north_face_jackets": "https://www.avito.ru/all/odezhda_obuv_aksessuary/muzhskaya_odezhda/verhnyaya_odezhda-ASgBAgICAkTeAtgL4ALeCw?cd=1&f=ASgBAgICBUTeAtgL4ALeC~K8De7RNKaNDrzEpgHkjg7eps4B&q=north+face&s=104"
}
